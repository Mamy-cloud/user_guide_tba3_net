creerCarte(
    "Tableau de bord",
    `
    <p>Voici les éléments dans le tableau de bord</p>
    <ol>
        ...
        <ol>
            ...
            <p>Il permet de vérifier le status d'un produit: "Actif" ou "A valider"</p>
        ...
        <ol>
            ...
            <p>Rediection vers la page de boîte de réception des notifications pour les messages, demande RFQ et devis d'un fournisseur</p>

            <li>Demande RFQ:</li>
            <p>Redirection vers la page de demande de devis (RFQ) qui les liste</p>

            <li>Commande:</li>
            <p>Redirection vers la page des listes et les status de livraison d'une commande</p>
